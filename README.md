...
>## Codelists
In codelits file, we have csv codelist **with id** and **without id**. These codelist without id came directly from OpenCodelist using "**opensafely codelists add**" and **the codelist link**, and they will be used for the analysis. The others with **-id.cv**,are downloaded manuel .They will not be used for this studu
