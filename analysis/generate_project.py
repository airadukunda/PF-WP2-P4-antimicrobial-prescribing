...
start_dates = ["2024-02-01", "2024-03-01", "2024-04-01"]
...
for d in start_dates:
    ...
    project["actions"][action_name] = {
        "run": f"ehrql:v1 generate-dataset analysis/dataset_definition_patients_monthly.py --output output/dataset_patients_{d}.csv.gz -- --start_date {d}",
        "outputs": {
            "highly_sensitive": {
