...
for name, codes in all_conditions_gp_codes.items():
    ...
    ae_condition_events = ae_events.where(ae_events.id.is_in(attendance_ids))
    # Any condition-specific medication
    count_medication, count_medication_episode = has_event_count( ae_condition_events,codelists.pharmacy_first_condition_specific_medications_dict[name],)
