...
pivot_df.to_csv(f"{measures_dir}/flag_source_u16_summary_by_sex.csv")
...
plotting(df=pivot_df, title='Count from Each Source by sex', ylabel='Count', xlabel='Sex', legend='Source', filename="flag_source_u16_summary_by_sex.png")


#rename the snomed column for linkage
...
for file in file_descriptions.keys():
    ...
    pivot_df.to_csv(f"{measures_dir}/summary_u16_{file}.csv")
