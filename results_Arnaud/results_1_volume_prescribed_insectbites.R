...
#
#
p_trends_insectbite <- ggplot(national_monthly|>
    filter(condition =="Insect bite",month>="2022-02-01"),
  ...
  labs(
    title = "Antimicrobial prescribing rate for infected insect bites ",
